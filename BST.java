 ...
 * Filename: BST.java
 * <p>
 * Description: Binary Search tree. All elements to the right of an element must be greater than that element. The opposite is true for left side elements.
 * <p>
 * Course: CSC 364-001
 * @author Will St. Onge
 */
public class BST<E extends Comparable<E>> implements Tree<E> {
    ...
    public List<E> postorderList() {
    	return postorderList(root, new ArrayList<E>());
    }
    
    protected List<E> postorderList(TreeNode<E> root, List<E> list) {
    	if(root == null)
    		return list;
    ...
    public List<E> preorderList() {
    	return preorderList(root, new ArrayList<E>());
    }
    
    protected List<E> preorderList(TreeNode<E> root, List<E> list) {
    	if(root == null)
    		return list;
    	list.add(root.element);
    ...
    protected List<E> inorderList(TreeNode<E> root, List<E> list) {
    	if(root == null)
    		return list;
